...
import ar.edu.um.gestioneventos.repository.VentaRepository;
import ar.edu.um.gestioneventos.service.VentaService;
import ar.edu.um.gestioneventos.service.dto.VentaDTO;
import ar.edu.um.gestioneventos.service.mapper.VentaMapper;
...
class VentaResourceIT {
    ...
    private static final EstadoVenta DEFAULT_ESTADO = EstadoVenta.PENDIENTE;
    private static final EstadoVenta UPDATED_ESTADO = EstadoVenta.CONFIRMADA;
    ...
    public static Venta createEntity() {
        return new Venta().fechaVenta(DEFAULT_FECHA_VENTA).estado(DEFAULT_ESTADO);
    }
    ...
    public static Venta createUpdatedEntity() {
        return new Venta().fechaVenta(UPDATED_FECHA_VENTA).estado(UPDATED_ESTADO);
    }
    ...
    void putExistingVenta() throws Exception {
        ...
        updatedVenta.fechaVenta(UPDATED_FECHA_VENTA).estado(UPDATED_ESTADO);
    ...
    void partialUpdateVentaWithPatch() throws Exception {
        ...
        partialUpdatedVenta.fechaVenta(UPDATED_FECHA_VENTA).estado(UPDATED_ESTADO);
