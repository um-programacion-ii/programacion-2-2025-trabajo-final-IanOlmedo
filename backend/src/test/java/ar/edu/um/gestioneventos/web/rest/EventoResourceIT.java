...
import static ar.edu.um.gestioneventos.domain.EventoAsserts.*;
import static ar.edu.um.gestioneventos.web.rest.TestUtil.createUpdateProxyForBean;
import static ar.edu.um.gestioneventos.web.rest.TestUtil.sameNumber;
...
import ar.edu.um.gestioneventos.repository.EventoRepository;
import ar.edu.um.gestioneventos.service.dto.EventoDTO;
import ar.edu.um.gestioneventos.service.mapper.EventoMapper;
...
class EventoResourceIT {
    ...
    public static Evento createEntity() {
        return new Evento().titulo(DEFAULT_TITULO).fecha(DEFAULT_FECHA).resumen(DEFAULT_RESUMEN).precioEntrada(DEFAULT_PRECIO_ENTRADA);
    }
    ...
    public static Evento createUpdatedEntity() {
        return new Evento().titulo(UPDATED_TITULO).fecha(UPDATED_FECHA).resumen(UPDATED_RESUMEN).precioEntrada(UPDATED_PRECIO_ENTRADA);
    }
    ...
    void putExistingEvento() throws Exception {
        ...
        updatedEvento.titulo(UPDATED_TITULO).fecha(UPDATED_FECHA).resumen(UPDATED_RESUMEN).precioEntrada(UPDATED_PRECIO_ENTRADA);
    ...
    void partialUpdateEventoWithPatch() throws Exception {
        ...
        partialUpdatedEvento.titulo(UPDATED_TITULO).fecha(UPDATED_FECHA).resumen(UPDATED_RESUMEN);
    ...
    void fullUpdateEventoWithPatch() throws Exception {
        ...
        partialUpdatedEvento.titulo(UPDATED_TITULO).fecha(UPDATED_FECHA).resumen(UPDATED_RESUMEN).precioEntrada(UPDATED_PRECIO_ENTRADA);
