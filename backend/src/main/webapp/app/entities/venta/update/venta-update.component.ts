...
export class VentaUpdateComponent implements OnInit {
  ...
  estadoVentaValues = Object.keys(EstadoVenta);
  ...
  protected updateForm(venta: IVenta): void {
    ...
    this.usersSharedCollection = this.userService.addUserToCollectionIfMissing<IUser>(this.usersSharedCollection, venta.usuario);
  }
  ...
  protected loadRelationshipsOptions(): void {
    ...
    this.userService
      ...
      .pipe(map((users: IUser[]) => this.userService.addUserToCollectionIfMissing<IUser>(users, this.venta?.usuario)))
